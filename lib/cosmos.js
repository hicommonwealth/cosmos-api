...
function Getters(cosmosRESTURL) {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              isTxsPagination = path.includes('/txs');
  ...
  return {
    ...
    /* ============ STAKE ============ */
    delegatorTxs: function delegatorTxs(address, paginationOptions) {
      return get("/staking/delegators/".concat(address, "/txs"), paginationOptions);
    },
    stakingTxs: function () {
    ...
    validatorDelegations: function validatorDelegations(addr) {
      return get("/staking/validators/".concat(addr, "/delegations"));
    },
